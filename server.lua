local market = createMarker(2131.88037, -1150.37109, 23.16541, "cylinder", 2) -- Maker yeridir. Hastanenin arkasındaki otopark
...
function aracVer(game)
    ...
    aracTablo[game] = createVehicle(436, 2147.51562, -1142.87805, 25.00839) --436 olan araç ID'sidir mta araç ıdleri kısmından değiştirebilirsiniz.
